                ...
                >
                  ...
                  "
                        >
                            ...
                            >Hello
                                <?= Html::encode($model->first_name) ?> <?= Html::encode($model->last_name) ?></strong
                            >,
                    ...
                    "
                            >
                                ...
                                Thank you for registering in <?= Html::encode(Yii::$app->name) ?>.Please find below your credential.
                            </p>
                            <div
                                    style="
                      height: 15px;
                    ...
                    "
                      ...
                      font-weight: 400;
                      margin: 0;
                    "><strong style="font-size: 13px; font-weight: bold">Username:</strong> <?= Html::encode($model->email) ?></p>
                    ...
                    "
                      ...
                      font-weight: 400;
                      margin: 0;
                    "><strong style="font-size: 13px; font-weight: bold">Password:</strong> <?= Html::encode($pwd) ?></p>
