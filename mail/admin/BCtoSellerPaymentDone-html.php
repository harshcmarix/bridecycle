                                        ...
                                        <tr>
                                            <td style="border:0px;padding:20px 28px;background-color:#fff" valign="top">
                                                <table border="0" cellpadding="0" cellspacing="2" width="100%">
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <b>Hello <?= Html::encode($sellerModel->first_name) ?> <?= Html::encode($sellerModel->last_name) ?>
                                                                ,</b></td>
                                                    </tr>
                                                    <tr>
                                                        <td>&nbsp;</td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <p>
                                                                ...
                                                                ID: <?php echo Html::encode($model->order_id) ?> <br/>
                                                                Product
                                                                Name: <?php echo Html::encode($productModel->name) ?>
                                                                <br/>
                                                                Amount: <?php echo Html::encode(Yii::$app->formatter->asCurrency($model->amount)) ?>
                                                                <br/>
                                                            </p>
                                                            ...
                                                            $title = "";
                                                            $bcNote = "";
                                                            if (!empty($model->note_content)) {
                                                                $title = "Note from BrideCycle";
                                                                $bcNote = $model->note_content;
                                                            } ?>
                                                            <p>
                                                                <strong><?php echo Html::encode($title) ?></strong>
                                                                <br/>
                                                                <?php echo Html::encode($bcNote) ?>
                                                            </p>
                                                            <!--                                                            <p><strong>Username:</strong> -->
                                                            <?php //echo Html::encode($model->email) ?><!--</p>-->
