...
//                            }
                    ...
                    <h4><?= Html::encode('BrideCycle Earning : ') ?>
                        <strong><?php echo ($brideEarning != '-') ? str_replace('.', ',', Yii::$app->formatter->asCurrency($brideEarning)) : $brideEarning ?></strong>
                    </h4>
                </div>
                <div class="form-group">
                    <?php
                    ...
                    if (!empty($model) && $model instanceof \app\models\Order && !empty($model->paymentTransferDetail) && !empty($model->paymentTransferDetail->transfer_amount)) {
                        $brideEarning = $model->paymentTransferDetail->transfer_amount;
                    }
                    ?>
                    <h4><?= Html::encode('Seller Earning : ') ?>
                        <!--                        <strong>-->
                        <?php //echo (!empty($model->total_amount)) ? str_replace('.', ',', Yii::$app->formatter->asCurrency(($model->total_amount - $brideEarningAmount))) : "-" ?><!--</strong>-->
                        <strong><?php echo (!empty($brideEarning)) ? str_replace('.', ',', Yii::$app->formatter->asCurrency(($brideEarning))) : "-" ?></strong>
                    </h4>
                </div>
                <div class="form-group">
                    <?php
            ...
            <?php if (!empty($model) && !empty($model->shipping_method) && !empty($model->tracking_number)) { ?>
                <div class="col col-md-12">
                    ...
                    <div class="box box-border">
                        ...
                        <div class="box-body">
                            <div class="col col-md-6">
                                <div class="form-group">
                                    <h4><?= Html::encode('Tracking Number : ') ?>
                                        <strong><?php echo (!empty($model->tracking_number)) ? $model->tracking_number : "" ?></strong>
                                    </h4>
                                </div>
                            </div>
                            <div class="col col-md-6 text-right">
                                <div class="form-group">
                                    <h4><?= Html::encode('Shipping Method : ') ?>
                                        <strong><?php echo (!empty($model->shipping_method)) ? $model->shipping_method : "" ?></strong>
                                    </h4>
                                </div>
                            </div>
                            <?php if (!empty($model->tracking_url)) { ?>
                                <div class="col col-md-12">
                                    <div class="form-group">
                                        <h4><?= Html::encode('Tracking URL : ') ?>
                                            <strong><?php echo (!empty($model->tracking_url)) ? $model->tracking_url : "" ?></strong>
                                        </h4>
                                    </div>
                                </div>
                            <?php } ?>
