            ...
            <div class="row">
                <div class="col col-md-6">
                    <?= $form->field($model, 'user_id')->widget(\kartik\select2\Select2::class, [
                        'data' => ArrayHelper::map(User::find()->where(['id' => $model->user_id])->all(), 'id', function ($data) {
                ...
                <div class="col col-md-6">
                    <?= $form->field($model, 'user_address_id')->widget(\kartik\select2\Select2::class, [
                        'data' => ArrayHelper::map(UserAddress::find()->where(['id' => $model->user_address_id])->all(), 'id', function ($data) {
                            return $data['address'];
                        }),
