...
<aside class="main-sidebar">
    <section class="sidebar">
        ...
        $menuList[] = ['label' => 'Product', 'icon' => 'product-hunt', 'items' => [
            ['label' => 'All Product', 'icon' => 'fas fa-list', 'url' => ['product/index'], 'visible' => $visible, 'active' => ($route === 'admin/product/index' || $route === 'admin/product/create' || $route === 'admin/product/update' || $route === 'admin/product/view')],
            ['label' => "New Product", 'icon' => 'plus-square', 'url' => ['product/pending-index'], 'visible' => $visible, 'active' => ($route === 'admin/product/index' || $route === 'admin/product/create' || $route === 'admin/product/update' || $route === 'admin/product/view')],
        ],];
