...
class Product extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['is_receipt'], 'required', 'message' => getValidationErrorMsg('is_receipt_required', Yii::$app->language)],
            ...
            [['zip_code'], 'required', 'message' => getValidationErrorMsg('zip_code_required', Yii::$app->language)],
