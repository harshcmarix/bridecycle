...
class SizesSearch extends Sizes
{
     ...
     * @return ActiveDataProvider
     */
    public function searchForMobile($requestParams)
    {
        ...
        $query = self::find()->where(['status' => Sizes::STATUS_ACTIVE]);
        ...
        if (!empty($requestParams['product_category_id'])) {
            $query->andWhere(['sizes.product_category_id' => $requestParams['product_category_id']]);
        }


        $query->orderBy(['sizes.created_at' => SORT_DESC]);
