 ...
 */
class UserPurchasedSubscriptionsSearch extends UserPurchasedSubscriptions
{
    /**
    ...
    public function rules()
    {
        return [
            [['id', 'user_id'], 'integer'],
            [['transaction_id', 'subscription_id', 'date_time', 'status', 'created_at', 'updated_at'], 'safe'],
            [['amount'], 'number'],
        ];
    }
    ...
    public function search($requestParams, $userId = null)
    {
        ...
        if (!empty($requestParams['fields'])) {
            ...
            $select = ['user_purchased_subscriptions.*',];
        }
