...
/**
 * DressTypeSearch represents the model behind the search form of `app\models\DressType`.
 */
class DressTypeSearch extends DressType
{
    ...
    public function search($requestParams)
    {
        ...
        $dressTypeModelData = $activeDataProvider->getModels();
        ...
        $activeDataProvider->setModels($dressTypeModelData);
        return $activeDataProvider;
    }
}
