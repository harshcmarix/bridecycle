...
/**
 * SellerRatingSearch represents the model behind the search form of `app\models\SellerRating`.
 */
class SellerRatingSearch extends SellerRating
{
    /**
    ...
    {
        return [
            [['id', 'seller_id', 'user_id'], 'integer'],
            [['rate'], 'number'],
            [['review', 'created_at', 'updated_at'], 'safe'],
        ];
    }
    ...
    public function search($requestParams)
    {
        ...
        $query->groupBy('seller_rating.id');
