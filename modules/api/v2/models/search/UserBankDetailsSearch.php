...
/**
 * UserBankDetailsSearch represents the model behind the search form of `app\models\UserBankDetails`.
 */
class UserBankDetailsSearch extends UserBankDetails
{
    /**
    ...
    public function search($requestParams, $userId = null)
    {
        ...
        $query->groupBy('user_bank_details.id');
        ...
        $bankDetailModelData = $activeDataProvider->getModels();
        $activeDataProvider->setModels($bankDetailModelData);
        return $activeDataProvider;
    }
}
