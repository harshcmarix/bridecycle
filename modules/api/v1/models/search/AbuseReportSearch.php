...
/**
 * AbuseReportSearch represents the model behind the search form of `app\models\AbuseReport`.
 */
class AbuseReportSearch extends AbuseReport
{
    /**
