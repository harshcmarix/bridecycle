 ...
 */
class DressTypeController extends ActiveController
{
    /**
     * @var string
     */
    public $modelClass = 'app\models\DressType';

    /**
     * @var string
     */
    public $searchModelClass = 'app\modules\api\v1\models\search\DressTypeSearch';
